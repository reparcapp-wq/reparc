...
export function SettingsTools({ account, data, pwa, onRestore, onSignOut, onDeleteAccount, onMessage }: {
  ...
  return (
    <>
      <div className="overflow-hidden rounded-[1.35rem] border border-white/10 bg-[#121512] md:col-span-2" aria-label="Data and account tools">
        {([
      ...
      {toolSection === "app" && <article className="rounded-[1.5rem] border border-white/10 bg-[#121512] p-5 sm:p-6">
      ...
      {toolSection === "danger" && <article className="rounded-[1.5rem] border border-red-300/20 bg-red-300/[0.035] p-5 sm:p-6 md:col-span-2">
      ...
      {toolSection === "restore" && <article className="rounded-[1.5rem] border border-white/10 bg-[#121512] p-5 sm:p-6 md:col-span-2">
      ...
      {toolSection === "diagnostics" && <article className="rounded-[1.5rem] border border-white/10 bg-[#121512] p-5 sm:p-6">
      ...
      {toolSection === "feedback" && <article className="rounded-[1.5rem] border border-white/10 bg-[#121512] p-5 sm:p-6">
