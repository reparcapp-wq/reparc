...
import { Download, FileUp, MessageSquareText, RefreshCw, ShieldCheck, Smartphone, Trash2, Upload } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function SettingsTools({ account, data, pwa, onRestore, onSignOut, onDeleteAccount, onMessage }: {
  ...
  return (
    <>
      ...
      <article className="rounded-[1.5rem] border border-red-300/20 bg-red-300/[0.035] p-5 sm:p-6 md:col-span-2">
