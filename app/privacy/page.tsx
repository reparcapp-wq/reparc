...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="Privacy" title="Your data stays yours." summary="This notice explains what RepArc stores, why it is needed, where offline copies live, and how to remove it.">
      ...
      <section><h2>Retention and control</h2><p>Training data remains until you change or delete it. Submitted feedback is automatically deleted after 180 days, and opt-in diagnostics after 30 days. Account deletion removes the account and its live cloud training profile, feedback and diagnostics immediately, plus that account&apos;s offline copy on the current device. Provider backups may retain encrypted copies until their normal backup cycle expires. You can export CSV and JSON copies from Data &amp; account before deletion.</p></section>
