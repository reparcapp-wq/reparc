...
export default function TermsPage() {
  return (
    <LegalPage eyebrow="Terms & safety · 7 September 2026" title="Train with informed judgment." summary="RepArc is an adult strength-training log and planning aid. It does not replace individualized coaching or medical care.">
      ...
      <section><h2>Optional participation</h2><p>Accepting these terms does not authorize optional improvement-data collection. Participation requires a separate, default-off choice described in the Privacy Notice and can be withdrawn in Setup. User logs provide observational feedback, not proof of program safety or effectiveness. Recommendation changes require review and testing before release.</p></section>
