...
export const metadata: Metadata = { title: "Terms & safety · RepArc", description: "RepArc use terms and general strength-training safety limits." };

export default function TermsPage() {
  return (
    <LegalPage eyebrow="Terms & safety" title="Train with informed judgment." summary="RepArc is an adult strength-training log and planning aid. It does not replace individualized coaching or medical care.">
